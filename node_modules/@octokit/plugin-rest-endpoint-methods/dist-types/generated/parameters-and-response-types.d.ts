...
export declare type RestEndpointMethodTypes = {
    ...
    packages: {
        ...
        restorePackageForAuthenticatedUser: {
            parameters: RequestParameters & Omit<Endpoints["POST /user/packages/{package_type}/{package_name}/restore"]["parameters"], "baseUrl" | "headers" | "mediaType">;
            response: Endpoints["POST /user/packages/{package_type}/{package_name}/restore"]["response"];
        };
        restorePackageForOrg: {
            parameters: RequestParameters & Omit<Endpoints["POST /orgs/{org}/packages/{package_type}/{package_name}/restore"]["parameters"], "baseUrl" | "headers" | "mediaType">;
